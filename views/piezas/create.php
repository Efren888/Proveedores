...
<form action="index.php?accion=guardar&evento=crear&tabla=piezas" method="POST">
  <div class="form-group">
    ...
    <input type="text" required class="form-control" id="numpieza" name="numpieza" aria-describedby="numpieza"
      placeholder="Introduce pieza" value="<?= $_SESSION["datos"]["numpieza"] ?? "" ?>">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="nompieza" name="nompieza" placeholder="Introduce el Nombre de la pieza"
      value="<?= $_SESSION["datos"]["nompieza"] ?? "" ?>">
  ...
  <div class="form-group">
    ...
    <input type="number" min="0" step="any" pattern="^[0-9]+[.,]?([0-9]{0,2})$" class="form-control" id="preciovent"
      name="preciovent" placeholder="Introduce el Precio" value="<?= $_SESSION["datos"]["preciovent"] ?? "" ?>">
