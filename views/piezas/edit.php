...
//$piezaInv = $controladorInv->ver($id);

$controladorLinea = new lineaPedidosController();
//$piezaLinea = $controladorLinea->ver($id);

$controladorPreSum = new precioSumsController();
//$piezaPreSum = $controladorPreSum->ver($id);
